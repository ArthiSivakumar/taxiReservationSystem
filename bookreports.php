...
<div id="content">
	...
	<div id="page">
		<div id="column1" style="font-size:17px";>
		<h1><center>WELCOME ADMIN</center></h1>
			<form name="myform1" action="bookrep.php"  method="post" style="position:relative;font-fammily:Arial;font-size:15px;">
					<p>CUSTOMER'S DETAILS
						<input type="radio" name="cbuk" id="cbuk" value="b" style="position:relative;left:9%"><label style="position:relative;left:11%">Booking &nbsp;&nbsp;&nbsp;&nbsp;</label>
						<input type="radio" name="cbuk" id="cbuk" value="c" style="position:relative;left:9%"><label style="position:relative;left:10%">Cancellation &nbsp;&nbsp;&nbsp;</label>
						<input type="radio" name="cbuk" id="cbuk" value="a" style="position:relative;left:9%"><label style="position:relative;left:11%">Both </label>
					</p><br/>			
...
<br/>
				...
				<p style="position:relative;height:3%;width:100%;left:15%">		DATE OF JOURNEY 
						...
						<p style="position:relative;height:3%;width:100%;left:15%">	 END OF JOURNEY
								<input type="radio" name="daord" id="daord" value="asc"style="position:relative;left:14%"><label style="position:relative;left:16%">Ascending</label>
								<input type="radio" name="daord" id="daord" value="desc" style="position:relative;left:21%"><label style="position:relative;left:23%">Descending </label>
						</p>
				<br/>	
				NUMBER OF BOOKINGS <label style="position:relative;height:3%;width:100%;left:22%">
				<input type="radio" name="noofbuk" id="noofbuk" value="max">&nbsp;&nbsp; Max &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="radio" name="noofbuk" id="noofbuk" value="min">&nbsp;&nbsp; Min </label>
				<br/><br/>
				
				<input type="radio" name="cbuk1" id="cbuk1" value="b" style="position:relative;left:35%"><label style="position:relative;left:37%">Booking &nbsp;&nbsp;&nbsp;</label>
				<input type="radio" name="cbuk1" id="cbuk1" value="c" style="position:relative;left:35%"><label style="position:relative;left:37%">Cancellation &nbsp;&nbsp;&nbsp;</label>
				<input type="radio" name="cbuk1" id="cbuk1" value="a" style="position:relative;left:35%"><label style="position:relative;left:37%">Both </label></br>
<br/>
TIMING	:	<select name="time1" id="time1" style="position:relative;height:3%;width:20%;left:26%">
