...
<form name="myform1" action="cug.php"  method="post" style="position:relative;font-fammily:Arial;font-size:15px;">
<p>CUG NO	:			<?php	$i=0;
									echo "<select name='cugno' id='cugno' style='position:relative;height:3%;width:20%;left:25%'>";
									echo "<option value='all'>".All."</option>";
									for($i=0;$i<$pi+1;$i=$i+1){
											echo "<option value='$cugno[$i]'>".$cugno[$i]."</option>";
									}
...
<br/>
				...
				ORDER BY <br/> 	
				<p style="position:relative;height:3%;width:100%;left:15%">		DATE OF JOINING
						...
						<p style="position:relative;height:3%;width:100%;left:15%">		DISTANCE
								<input type="radio" name="daord" id="daord" value="asc"style="position:relative;left:23%"><label style="position:relative;left:25%">Ascending</label>
								<input type="radio" name="daord" id="daord" value="desc" style="position:relative;left:30%"><label style="position:relative;left:31%">Descending </label>
						</p>
				<br/>	
				NUMBER OF DRIVERS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="radio" name="noofcug" id="noofcug" value="Max">&nbsp;&nbsp;&nbsp; Max &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<input type="radio" name="noofcug" id="noofcug" value="Min">&nbsp;&nbsp;&nbsp; Min			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select name="time1" id="time1">
						<option value="none">None</option>
						<option value="hourly">Hourly</option>
						<option value="daily">Daily</option>
						<option value="weekly">Weekly</option>
