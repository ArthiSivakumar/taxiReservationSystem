...
BEGIN
	IF taxino!='all' THEN
		...
		END IF;
	ELSEIF taxino='all' THEN
		IF orderbydoj='asc' and orderbydist='asc' THEN
			select * from booking_details where travel_status='b' and EXTRACT(HOUR FROM date_of_booking)=EXTRACT(HOUR FROM CURRENT_TIMESTAMP()) and EXTRACT(DAY FROM date_of_booking)=EXTRACT(DAY FROM CURRENT_DATE())
			order by date_of_journey asc, distance asc;
		END IF;
		IF orderbydoj='desc' and orderbydist='asc' THEN
			select * from booking_details where travel_status='b' and EXTRACT(HOUR FROM date_of_booking)=EXTRACT(HOUR FROM CURRENT_TIMESTAMP()) and EXTRACT(DAY FROM date_of_booking)=EXTRACT(DAY FROM CURRENT_DATE())
...
BEGIN
	...
	ELSEIF taxino='all' THEN
		IF orderbydoj='asc' and orderbydist='asc' THEN
			select * from booking_details where travel_status='b' and EXTRACT(DAY FROM date_of_booking)=EXTRACT(DAY FROM CURRENT_DATE())
			order by date_of_journey asc, distance asc;
		END IF;
		IF orderbydoj='desc' and orderbydist='asc' THEN
			select * from booking_details where travel_status='b' and EXTRACT(DAY FROM date_of_booking)=EXTRACT(DAY FROM CURRENT_DATE())
...
BEGIN
	...
	ELSEIF taxino='all' THEN
		IF orderbydoj='asc' and orderbydist='asc' THEN
			select * from booking_details where travel_status='b' and EXTRACT(WEEK FROM date_of_booking)=EXTRACT(WEEK FROM CURRENT_DATE())
			order by date_of_journey asc, distance asc;
		END IF;
		IF orderbydoj='asc' and orderbydist='desc' THEN
			select * from booking_details where travel_status='b' and EXTRACT(WEEK FROM date_of_booking)=EXTRACT(WEEK FROM CURRENT_DATE())
...
BEGIN
	...
	ELSEIF taxino='all' THEN
		IF orderbydoj='asc' and orderbydist='asc' THEN
			select * from booking_details where travel_status='b' and EXTRACT(MONTH FROM date_of_booking)=EXTRACT(MONTH FROM CURRENT_DATE())
			order by date_of_journey asc, distance asc;
		END IF;
		IF orderbydoj='asc' and orderbydist='desc' THEN
			select * from booking_details where travel_status='b' and EXTRACT(MONTH FROM date_of_booking)=EXTRACT(MONTH FROM CURRENT_DATE())
...
BEGIN
	...
	ELSEIF taxino='all' THEN
		IF orderbydoj='asc' and orderbydist='asc' THEN
			select * from booking_details where travel_status='b' and EXTRACT(YEAR FROM date_of_booking)=EXTRACT(YEAR FROM CURRENT_DATE())
			order by date_of_journey asc, distance asc;
		END IF;
		IF orderbydoj='asc' and orderbydist='desc' THEN
			select * from booking_details where travel_status='b' and EXTRACT(YEAR FROM date_of_booking)=EXTRACT(YEAR FROM CURRENT_DATE())
...
BEGIN
	...
	ELSEIF taxino='all' THEN
		IF orderbydoj='asc' and dist='asc' THEN
			select * from booking_details where travel_status='b' and date_of_booking>=starttime and date_of_booking<=endtime
			order by date_of_journey asc, distance asc;
		END IF;
		IF orderbydoj='desc' and dist='asc' THEN
			select * from booking_details where travel_status='b' and date_of_booking>=starttime and date_of_booking<=endtime
...
DROP PROCEDURE IF EXISTS ListTaxi;
DELIMITER $$
CREATE PROCEDURE ListTaxi()
BEGIN
	select * from taxi order by date_of_joining, salary desc;
END$$
DELIMITER ;;-